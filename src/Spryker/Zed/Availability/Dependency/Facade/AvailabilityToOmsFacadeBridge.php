...
class AvailabilityToOmsFacadeBridge implements AvailabilityToOmsFacadeInterface
{
    /**
    ...
    {
        return $this->omsFacade->getOmsReservedProductQuantityForSkus($skus, $storeTransfer);
    }
}
